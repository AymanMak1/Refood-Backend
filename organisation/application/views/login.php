...
<head>
  ...
  <![endif]-->
<?php 				$this->load->model('Organisationtype_model');
			$all_organisationtypes = $this->Organisationtype_model->get_all_organisationtypes(); ?>
  <!-- Google Font -->
  ...
  <div class="login-box-body"style="background-color:#142A4F; border-radius: 50px;color:white">
              <div class="card-header">
                <h3 class="card-title" style="color:#879BAF;margin:0px 40%">Sign up</h3>
			              ...
			              <?php echo form_open('organisation/register','enctype="multipart/form-data"'); ?>
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="organisationDescription" value="<?php echo $this->input->post('organisationDescription'); ?>" class="form-control" id="organisationDescription" />
                  </div>
                  <div class="form-group">
              ...
              <div class="form-group">
                    <label for="exampleInputPassword1">Logo</label>
							<input  type="file" class="custom-file-input" name="organisationLogo" value="<?php echo $this->input->post('organisationLogo'); ?>" class="form-control" id="organisationLogo" />
                  </div>
