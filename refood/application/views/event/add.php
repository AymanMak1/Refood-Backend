          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="time" value="<?php echo $this->input->post('time'); ?>" class="has-datepicker form-control" id="time" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="organisationComiteeNumber" value="<?php echo $this->input->post('organisationComiteeNumber'); ?>" class="form-control" id="organisationComiteeNumber" />
						</div>
					</div>
				</div>
			</div>
