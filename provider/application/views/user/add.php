<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('user/add','enctype="multipart/form-data"'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="admin" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('admin')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="volunteer" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('volunteer')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="datebirthday" value="<?php echo $this->input->post('datebirthday'); ?>" class="has-datepicker form-control" id="datebirthday" />
						</div>
					</div>
					<div class="col-md-6">
